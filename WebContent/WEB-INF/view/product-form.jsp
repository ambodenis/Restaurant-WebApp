                  ...
                  <div class="row">
					...
					<div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <form:errors cssClass="text-danger" path="recipe.name"/>
                      </div>
                      <div class="form-group">
                        <label>Recipe description</label>
                        <form:textarea class="form-control" placeholder="Enter recipe description" path="recipe.description"/>
                        <form:errors cssClass="text-danger" path="recipe.description"/>
                      </div>
                      
                      <div class="form-group">
                        <label>Tags</label>
                        <form:select path="tags" items="${tagList}" itemValue="id" itemLabel="name" multiple="true" class="form-control"/>
